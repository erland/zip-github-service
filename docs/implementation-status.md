...
| `r0160` | 2026-08-14 | `9.31` runtime version and PR-aware import result | About shows the CI-injected root VERSION; import result reconciles current Work and suppresses duplicate PR creation when PR_OPEN | `none` |
