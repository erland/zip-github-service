...
for required in \
  ...
  docs/step-9.5-report.md docs/step-9.6-report.md docs/step-9.7-report.md docs/step-9.8-report.md docs/step-9.9-report.md docs/step-9.11-report.md \
...
grep -q 'ActionsPanel' frontend/src/pages/ProjectDetailPage.tsx
