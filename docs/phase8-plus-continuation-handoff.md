> **Current handoff r0137 / 1.0.0-rc.89:** Phase 9 has been extended with repository-selection UX. Step 9.21 is complete: landing and Shortcut claim reuse a searchable `RepositoryPicker`, long lists scroll independently, up to five client-side recent repositories are surfaced, and Shortcut always shows the selected repository beside Continue. Step 9.22 is NEXT and should add confidence-ranked Shortcut suggestions from filename, prior upload filenames and recency without implicit promotion.
