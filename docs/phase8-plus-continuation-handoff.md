> **Current handoff r0121 / 1.0.0-rc.73:** Phase 9 remains complete. Step 9.14 adds a manual GitHub Actions production deployment path using a restricted `zip-github-deploy` SSH identity, root-owned deploy script and explicit `production` Environment. Repository-first UX from 9.13 remains unchanged.
